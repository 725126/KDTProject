...
export const ordUploadBtnTutorial = "발주 내역을 반영합니다.";
export const ordStatBtnTutorial = "발주 내역의 상태를 변경합니다.";
export const ordQtyBtnTutorial = "아래 표에서 연관된 진척도를 찾습니다. 장납기에만 적용됩니다.";
export const insUploadBtnTutorial = "진척 검수 내역을 반영합니다.";
export const insQtyTutorial = "진척 검수 수치를 입력합니다. 앞에 +를 붙여 증가량을, -를 붙여 감소량을 설정할 수 있습니다.";
export const insStatTutorial = "제작 진척이 소요량에 도달하면 자동으로 완료 상태가 됩니다.";